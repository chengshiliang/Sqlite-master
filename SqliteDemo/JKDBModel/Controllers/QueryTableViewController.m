...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *departNameLable = (UILabel *)[cell viewWithTag:105];
    UILabel *departNumberLable = (UILabel *)[cell viewWithTag:106];
    ...
    Depart *depart = user.depart;
    departNameLable.text = depart.departName;
    departNumberLable.text = depart.departNum;
    return cell;
}
